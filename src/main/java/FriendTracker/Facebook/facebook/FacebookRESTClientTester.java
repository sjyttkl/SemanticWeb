package FriendTracker.Facebook.facebook;
...
//   private static final String FIREFOX_LOCATION = "/usr/bin/firefox";
   ...
   public static void main(String[] args) throws IOException
   {
      ...
      do
      {
         try
         {
            ...
            else if(inLine.toLowerCase().equals("listfriends"))
            {
